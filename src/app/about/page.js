  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-black-100"> {/* Container with pink background */}
      ...
      <p className="text-black-700 leading-loose text-center">  {/* Centered paragraph with gray text */}
        Hello! My name is Tiffany Sharpe. I am a Fullstack Developer with a passion
        for creating beautiful and functional websites. I have been working as a
        developer since January 2024 and I am always eager to learn and improve my
        skills.
      </p>
